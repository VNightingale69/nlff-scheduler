...
class GameScore(Base, TimestampMixin):
    ...
    home_forfeit: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    away_forfeit: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
...
class ScoreSubmission(Base, TimestampMixin):
    ...
    home_forfeit: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    away_forfeit: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    submitted_home_score_raw: Mapped[str | None] = mapped_column(String(30), nullable=True)
    submitted_away_score_raw: Mapped[str | None] = mapped_column(String(30), nullable=True)
    normalized_home_score_display: Mapped[str | None] = mapped_column(String(30), nullable=True)
    normalized_away_score_display: Mapped[str | None] = mapped_column(String(30), nullable=True)
    ...
    normalization_note: Mapped[str | None] = mapped_column(Text, nullable=True)
