...
class HostLocation(Base, TimestampMixin):
    ...
    field_area_name: Mapped[str | None] = mapped_column(String(120))
    setup_constraints: Mapped[str | None] = mapped_column(Text)
    ...
    can_support_small: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    can_support_medium: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    can_support_large: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    organization = relationship('Organization')
