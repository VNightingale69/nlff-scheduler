...
const HOST_CONFIG_OPTIONS = APPROVED_TURF_CONFIGURATIONS.map((config) => ({
  value: config.code,
  label: `${config.code} — ${config.displayName}`,
}));
