...
export const ENTITIES: Record<string, EntityConfig> = {
  ...
  teams: { title: 'Teams', path: '/teams', nav: true, fields: [{ key: 'organization_id', label: 'Organization ID' }, { key: 'division_id', label: 'Division ID' }, { key: 'name', label: 'Name' }, { key: 'is_active', label: 'Active', type: 'checkbox' }] },
