...
export const ENTITIES: Record<string, EntityConfig> = {
  ...
  weeks: { title: 'Weeks', path: '/weeks', nav: true, fields: [{ key: 'season_id', label: 'Season', type: 'select' }, { key: 'week_number', label: 'Week Number', type: 'number' }, { key: 'start_date', label: 'Start Date', type: 'date' }, { key: 'end_date', label: 'End Date', type: 'date' }] },
  ...
  'schedule-management': { title: 'Schedule Management', path: '/schedule-management', nav: true, roles: ['league_admin'], fields: [] },
